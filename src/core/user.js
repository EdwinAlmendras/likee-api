...
var User = /** @class */ (function () {
    ...
    User.prototype.userInfo = function (_a) {
        var uid = _a.uid;
    ...
    User.prototype.follows = function (_a) {
        var uid = _a.uid;
        return __awaiter(this, void 0, void 0, function () {
            var data, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.client.api.custom({
                                url: "https://likee.video/official_website/UserApi/getUserFollow",
                                data: querystring_1.default.stringify({ uid: uid }),
                                method: "POST",
                            })];
                    case 1:
                        data = (_b.sent()).data;
    ...
    User.prototype.follow = function (uid) {
        return __awaiter(this, void 0, void 0, function () {
            var error_3;
